...
VALUES
(   'UserSaleByRegion-dh-import',        -- WidgetName - varchar(500)
    'User Sale by Region-Import',        -- Name - varchar(250)
    'dbo.CRM_GetUserSalesByRegion_Import',        -- Location - varchar(500)
