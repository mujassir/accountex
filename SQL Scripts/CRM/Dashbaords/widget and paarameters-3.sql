...
VALUES
(   'UserSaleByAllDivision-import',        -- WidgetName - varchar(500)
    'User Sale by Division Import',        -- Name - varchar(250)
    'dbo.CRM_GetUserSalesByDivision_Import',        -- Location - varchar(500)
	...
	DECLARE @WidgetId INT=93
	DECLARE @SelectWidgetId INT=92
