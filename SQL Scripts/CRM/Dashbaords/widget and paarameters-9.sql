...
VALUES
(   'UserSaleByRegion-dh',        -- WidgetName - varchar(500)
    'User Sale by Region',        -- Name - varchar(250)
    'dbo.CRM_GetUserSalesByRegion_All',        -- Location - varchar(500)
