...
namespace AccountEx.CodeFirst.Models.CRM
{
    ...
    public partial class CRMCustomer : BaseEntity
    {
        public CRMCustomer()
        {
            CRMCustomerSalePersons = new HashSet<CRMCustomerSalePerson>();
        ...
        public decimal? Capicty { get; set; }
        ...
        public virtual ICollection<CRMCustomerSalePerson> CRMCustomerSalePersons { get; set; }
