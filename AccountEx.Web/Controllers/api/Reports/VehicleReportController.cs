...
namespace AccountEx.Web.Controllers.api.Reports
{
    ...
    public class VehicleReportController : BaseApiController
    {
            ...
            try
            {
                switch (key)
                {
                    ...
                    case "GetActiveStocks":
                        ...
                        break;
                    case "GetTransfeerStocks":
                        response = GetTransfeerStocks();
                        break;
                    case "GetRepossessedStocks":
                        response = GetRepossessedStocks();
                        break;
                    case "GetDeliveredStock":
                        response = GetDeliveredStock();
                        break;
                    case "GetSoldStockAnalysisByDate":
                        response = GetSoldStockAnalysisByDate();
                        break;
                    case "GetSoldStockAnalysis":
                        response = GetSoldStockAnalysis();
                        break;
                    case "GetVehicleFollowups":
                        response = GetVehicleFollowups();
                        break;
                    case "GetCashBankSummary":
                        response = GetCashBankSummary();
                        break;
        ...
        private ApiResponse GetActiveStocks()
        {
            ...
            var records = repo.GetVehicleActiveStocks(branchId);
            var response = new ApiResponse
            {
                Success = true,
                Data = records
        ...
        private ApiResponse GetTransfeerStocks()
        {
            ...
            var branchId = Numerics.GetInt(Request.GetQueryString("branchId"));
            var repo = new ReportRepository();
            var records = repo.GetVehicleTransfeerStock(branchId);
            var response = new ApiResponse
            {
                Success = true,
                Data = records
