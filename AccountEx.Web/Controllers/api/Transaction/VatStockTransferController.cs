...
{
    public class VatStockTransferController : BaseApiController
    {
        public ApiResponse Get(int id)
        {
            ...
            try
            {
                ...
                if (key == "nextvouchernumber")
                {
                    ...
                    invoiceNumber = saleRepo.GetLastInvoiceNumber(vouchertype);
                }
        ...
        public ApiResponse Post([FromBody]Sale input)
        {
            ...
            try
            {
                ...
                if (err == "")
                {
                    ...
                    VatTransManager.SaveStockTransfer(input);
                    response = new ApiResponse
                    {
                        Success = true,
