...
{
    public class StoreTransactionController : BaseApiController
    {
        // GET api/test
        ...
        public ApiResponse Get(int id)
        {
            ...
            try
            {
                ...
                var data = new StoreTransactionRepository().GetById(id);
        ...
        public ApiResponse Post([FromBody]PurchaseExtra input)
        {
            ...
            try
            {
                ...
                {
                    new StoreTransactionRepository().Save(input);

                }
                else
                {
                    new StoreTransactionRepository().Update(input);
                }
