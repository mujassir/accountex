...
{
    public class CRMSaleForecastController : BaseApiController
    {
        ...
        public ApiResponse Get(int id)
        {
            ...
            try
            {
                var data = new CRMSaleInvoiceRepository().GetSaleForSalePerson(salePersonId, month, year, customerId, productId);
