...
{
    public class CRMVendorController : GenericApiController<CRMVendor>
    {

        public override ApiResponse Post([FromBody]CRMVendor input)
        {
        ...
        private string ServerValidateSave(CRMVendor input)
        {
            var err = ",";
            try
            {
        ...
        protected override JQueryResponse GetDataTable()
        {
            ...
            var coloumns = new[] { "Name", "Supplier", "ContactPerson", "Email", "CellNo", "Web", "NTN", "Email", "" };
