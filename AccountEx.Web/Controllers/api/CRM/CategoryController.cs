...
{
    public class CategoryController : GenericApiController<ProductCategory>
    {

        public override ApiResponse Post([FromBody]ProductCategory input)
        {
        ...
        private string ServerValidateSave(ProductCategory input)
        {
            var err = ",";
            try
            {
