...
{
    public class ProductSecondaryCategoryController : GenericApiController<ProductSecCategory>
    {

        public override ApiResponse Post([FromBody]ProductSecCategory input)
        {
        ...
        private string ServerValidateSave(ProductSecCategory input)
        {
            var err = ",";
            try
            {
