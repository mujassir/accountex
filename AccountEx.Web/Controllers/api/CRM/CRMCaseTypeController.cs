...
{
    public class CRMCaseTypeController : GenericApiController<CRMCaseType>
    {

        public override ApiResponse Post([FromBody]CRMCaseType input)
        {
        ...
        private string ServerValidateSave(CRMCaseType input)
        {
            var err = ",";
            try
            {
