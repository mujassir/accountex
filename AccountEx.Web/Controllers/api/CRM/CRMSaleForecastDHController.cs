...
{
    public class CRMSaleForecastDHController : BaseApiController
    {
        ...
        public ApiResponse Get(int id)
        {
            ...
            var salePersonId = SiteContext.Current.User.Id;
            ...
            try
            {
                var data = new CRMSaleInvoiceRepository().GetSaleForDH(salePersonId, month, year, customerId, productId);
        ...
        public ApiResponse Post([FromBody]List<CRMSaleForecast> events)
        {
            ApiResponse response;
            try
            {
                var err = CRMSaleForecastManager.ValidateSave(events);
                if (err == "")
                {
                    CRMSaleForecastManager.Save(events);
