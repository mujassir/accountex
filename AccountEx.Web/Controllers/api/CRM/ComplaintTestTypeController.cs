...
{
    public class ComplaintTestTypeController : GenericApiController<ComplaintTest>
    {

        public override ApiResponse Post([FromBody]ComplaintTest input)
        {
        ...
        private string ServerValidateSave(ComplaintTest input)
        {
            var err = ",";
            try
            {
