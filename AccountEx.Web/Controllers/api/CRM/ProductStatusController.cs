...
{
    public class ProductStatusController : GenericApiController<ProductStatus>
    {

        public override ApiResponse Post([FromBody]ProductStatus input)
        {
        ...
        private string ServerValidateSave(ProductStatus input)
        {
            var err = ",";
            try
            {
