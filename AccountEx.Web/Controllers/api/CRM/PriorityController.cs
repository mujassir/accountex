...
{
    public class PriorityController : GenericApiController<Priority>
    {

        public override ApiResponse Post([FromBody]Priority input)
        {
        ...
        private string ServerValidateSave(Priority input)
        {
            var err = ",";
            try
            {
