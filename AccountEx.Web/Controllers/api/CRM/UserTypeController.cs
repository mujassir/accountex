...
{
    public class UserTypeController : GenericApiController<UserType>
    {

        public override ApiResponse Post([FromBody]UserType input)
        {
        ...
        private string ServerValidateSave(UserType input)
        {
            var err = ",";
            try
            {
