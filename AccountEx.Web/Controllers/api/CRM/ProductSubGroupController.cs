...
{
    public class ProductSubGroupController : GenericApiController<ProductSubGroup>
    {


        public override ApiResponse Post([FromBody]ProductSubGroup input)
        {
        ...
        private string ServerValidateSave(ProductSubGroup input)
        {
            var err = ",";
            try
            {
        ...
        protected override JQueryResponse GetDataTable()
        {
            ...
            var records = new GenericRepository<vw_ProductSubGroups>().AsQueryable();
