...
{
    public class ComplaintLabController : GenericApiController<ComplaintLab>
    {

        public override ApiResponse Post([FromBody]ComplaintLab input)
        {
        ...
        private string ServerValidateSave(ComplaintLab input)
        {
            var err = ",";
            try
            {
