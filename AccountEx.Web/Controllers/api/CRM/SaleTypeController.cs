...
{
    public class SaleTypeController : GenericApiController<SaleType>
    {

        public override ApiResponse Post([FromBody]SaleType input)
        {
        ...
        private string ServerValidateSave(SaleType input)
        {
            var err = ",";
            try
            {
