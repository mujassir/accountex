...
{
    public class EventStatusController : GenericApiController<EventStatus>
    {

        public override ApiResponse Post([FromBody]EventStatus input)
        {
        ...
        private string ServerValidateSave(EventStatus input)
        {
            var err = ",";
            try
            {
