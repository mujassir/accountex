...
{
    public class ProductLostReasonController : GenericApiController<ProductLostReason>
    {

        public override ApiResponse Post([FromBody]ProductLostReason input)
        {
        ...
        private string ServerValidateSave(ProductLostReason input)
        {
            var err = ",";
            try
            {
