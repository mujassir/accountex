...
{
    public class ComplaintStatusController : GenericApiController<ComplaintStatus>
    {

        public override ApiResponse Post([FromBody]ComplaintStatus input)
        {
        ...
        private string ServerValidateSave(ComplaintStatus input)
        {
            var err = ",";
            try
            {
