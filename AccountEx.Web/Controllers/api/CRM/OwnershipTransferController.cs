...
{
    public class OwnershipTransferController : GenericApiController<CRMOwnershipTransfer>
    {

        public override ApiResponse Post([FromBody]CRMOwnershipTransfer input)
        {
            ApiResponse response;
            try
            {
                var err = OwnershipTransferManager.Validate(input);
                if (err == "")
                {
                    OwnershipTransferManager.Transfer(input);
