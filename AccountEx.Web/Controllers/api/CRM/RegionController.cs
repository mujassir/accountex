...
{
    public class RegionController : GenericApiController<Region>
    {

        public override ApiResponse Post([FromBody]Region input)
        {
        ...
        private string ServerValidateSave(Region input)
        {
            var err = ",";
            try
            {
