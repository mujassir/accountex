...
{
    public class ClusterTypeController : GenericApiController<ClusterType>
    {

        public override ApiResponse Post([FromBody]ClusterType input)
        {
        ...
        private string ServerValidateSave(ClusterType input)
        {
            var err = ",";
            try
            {
