...
{
    public class DivisionController : GenericApiController<Division>
    {

        public override ApiResponse Post([FromBody]Division input)
        {
        ...
        private string ServerValidateSave(Division input)
        {
            var err = ",";
            try
            {
        ...
        protected override JQueryResponse GetDataTable()
        {
            ...
            var records = new GenericRepository<vw_Divisions>().AsQueryable();
