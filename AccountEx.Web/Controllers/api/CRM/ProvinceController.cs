...
{
    public class ProvinceController : GenericApiController<Province>
    {

        public override ApiResponse Post([FromBody]Province input)
        {
        ...
        private string ServerValidateSave(Province input)
        {
            var err = ",";
            try
            {
