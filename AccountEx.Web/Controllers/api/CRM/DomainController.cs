...
{
    public class DomainController : GenericApiController<Domain>
    {

        public override ApiResponse Post([FromBody]Domain input)
        {
        ...
        private string ServerValidateSave(Domain input)
        {
            var err = ",";
            try
            {
