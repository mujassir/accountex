...
{
    public class ContactGroupController : GenericApiController<ContactGroup>
    {

        public override ApiResponse Post([FromBody]ContactGroup input)
        {
        ...
        private string ServerValidateSave(ContactGroup input)
        {
            var err = ",";
            try
            {
