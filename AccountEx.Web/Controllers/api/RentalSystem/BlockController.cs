...
{
    public class BlockController : GenericApiController<Block>
    {
        protected override JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                data.Add(item.Name);
                var editIcon = "<i class='fa fa-edit' onclick=\"Blocks.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"Blocks.Delete(" + item.Id + ")\" title='Delete' ></i>";
