...
{
    public class NexusDepartmentMappingController :GenericApiController<NexusDepartmentMapping>
    {
        ...
        protected override JQueryResponse GetDataTable()
        {
            ...
            var coloumns = new[] { "NexusDepartmentName", "AmexDepartment", "" };
            ...
            var records = new GenericRepository<vw_NexusDepartmentMapping>().AsQueryable();
            var totalRecords = records.Count();
            var filteredList = records;
            if (search != "")
                filteredList = records.Where(p =>

                     p.NexusDepartmentName.Contains(search) ||
                      p.AmexDepartment.Contains(search) 
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                data.Add(item.NexusDepartmentName);
                data.Add(item.AmexDepartment);
