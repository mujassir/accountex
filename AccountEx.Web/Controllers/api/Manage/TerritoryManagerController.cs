...
{
    public class TerritoryManagerController : AccountDetailController
    {
        public TerritoryManagerController() 
        {
            AccountDetailFormId = (int)AccountDetailFormType.TerritoryManagers;
            HeadAccountId = SettingManager.TerritoryManagerHeadId;
        }
        protected override JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                var editIcon = "<i class='fa fa-edit' onclick=\"TerritoryManagers.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"TerritoryManagers.Delete(" + item.Id + ")\" title='Delete' ></i>";
