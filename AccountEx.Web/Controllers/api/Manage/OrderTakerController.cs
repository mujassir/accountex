...
{
    public class OrderTakerController : AccountDetailController
    {
        public OrderTakerController() 
        {
            AccountDetailFormId = (int)AccountDetailFormType.OrderTakers;
            HeadAccountId = SettingManager.OrderTakerHeadId;
        }
        protected override JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                var editIcon = "<i class='fa fa-edit' onclick=\"OrderTakers.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"OrderTakers.Delete(" + item.Id + ")\" title='Delete' ></i>";
