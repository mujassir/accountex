...
{
    public class LocationController : GenericApiController<Location>
    {
        protected override JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                var editIcon = "<i class='fa fa-edit' onclick=\"Locations.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"Locations.Delete(" + item.Id + ")\" title='Delete' ></i>";
