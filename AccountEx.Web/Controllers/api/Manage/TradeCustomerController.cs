...
{
    public class TradeCustomerController : AccountDetailController
    {
        public TradeCustomerController()
        {
        ...
        protected override JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                var editIcon = "<i class='fa fa-edit' onclick=\"TradeCustomers.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"TradeCustomers.Delete(" + item.Id + ")\" title='Delete' ></i>";
