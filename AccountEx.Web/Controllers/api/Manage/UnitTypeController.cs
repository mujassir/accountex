...
{
    public class UnitTypeController : GenericApiController<UnitType>
    {
        protected override JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                data.Add(item.Name);
                var editIcon = "<i class='fa fa-edit' onclick=\"UnitTypes.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"UnitTypes.Delete(" + item.Id + ")\" title='Delete' ></i>";
