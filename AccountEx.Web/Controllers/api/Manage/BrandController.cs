...
{
    public class BrandController : GenericApiController<Brand>
    {
        ...
        protected override JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                data.Add(item.Name);
                var editIcon = "<i class='fa fa-edit' onclick=\"Brands.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"Brands.Delete(" + item.Id + ")\" title='Delete' ></i>";
