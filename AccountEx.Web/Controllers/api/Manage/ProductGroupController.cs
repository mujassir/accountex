...
{
    public class ProductGroupController : GenericApiController<ProductGroup>
    {

        public override ApiResponse Post([FromBody]ProductGroup input)
        {
        ...
        protected override JQueryResponse GetDataTable()
        {
            ...
            var coloumns = new[] { "Name", "Division", "" };
            ...
            var records = new GenericRepository<vw_ProductGroups>().AsQueryable();
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                data.Add(item.Name);
                var editIcon = "<i class='fa fa-edit' onclick=\"ProductGroups.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"ProductGroups.Delete(" + item.Id + ")\" title='Delete' ></i>";
        ...
        private string ServerValidateSave(ProductGroup input)
        {
            var err = ",";
            try
            {
