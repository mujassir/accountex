...
{
    public class ProductDiscountController : BaseApiController
    {
        // GET api/test
        public ApiResponse Get()
        {
            ...
            var list = new CustomerDiscountRepository().GetDiscountWithProducts();
        ...
        public ApiResponse Post([FromBody]CustomerDiscountExtra input)
        {
            ...
            try
            {
                ...
                new CustomerDiscountRepository().Save(input);
