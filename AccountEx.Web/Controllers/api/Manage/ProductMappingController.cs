...
{
    public class ProductMappingController : BaseApiController
    {
        // GET api/test
        public ApiResponse Get()
        {
            ...
            var list = new ProductMappingRepository().GetDiscountWithProducts(account);
        ...
        // POST api/test
        public ApiResponse Post([FromBody]ProductMappingExtra input)
        {
            ApiResponse response;
            try
            {

                ProductMappingManager.Save(input);
