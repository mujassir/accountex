...
{
    public class VehicleVoucherController : BaseApiController
    {
        ...
        public ApiResponse Post([FromBody]VehicleVoucher input)
        {
            ...
            try
            {
                ...
                if (err == "")
                {
                    ...
                    VoucherManager.SaveVehicleVoucher(input);
                    response = new ApiResponse
                    {
                        Success = true,
                        Data = input.Id
        ...
        public JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                var editIcon = "<i class='fa fa-edit' onclick=\"VehicleVoucher.Edit(" + item.VoucherNumber + ")\" title='Edit' ></i>";
