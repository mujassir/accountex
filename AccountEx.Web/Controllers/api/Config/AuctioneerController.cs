...
{
    public class AuctioneerController : GenericApiController<Auctioneer>
    {
        protected override JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                data.Add(item.Name);
                //data.Add(item.Unit);
                var editIcon = "<i class='fa fa-edit' onclick=\"Auctioneer.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"Auctioneer.Delete(" + item.Id + ")\" title='Delete' ></i>";
