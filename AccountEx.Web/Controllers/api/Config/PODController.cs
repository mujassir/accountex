...
{
    public class PODController : GenericApiController<PortOfDischarge>
    {

        public override ApiResponse Post([FromBody]PortOfDischarge input)
        {
        ...
        private string ServerValidateSave(PortOfDischarge input)
        {
            var err = ",";
            try
            {
