...
{
    public class ClearingCompanyController : GenericApiController<ClearingCompany>
    {



        public override ApiResponse Post([FromBody]ClearingCompany input)
        {
        ...
        private string ServerValidateSave(ClearingCompany input)
        {
            ...
            try
            {
                ...
                if (new ClearingCompanyRepository().IsExist(input.Name, input.Id))
                {
        ...
        protected override JQueryResponse GetDataTable()
        {
            ...
            foreach (var item in orderedList.Skip(displayStart).Take(displayLength))
            {
                ...
                var editIcon = "<i class='fa fa-edit' onclick=\"ClearingCompanies.Edit(" + item.Id + ")\" title='Edit' ></i>";
                var deleteIcon = "<i class='fa fa-trash-o' onclick=\"ClearingCompanies.Delete(" + item.Id + ")\" title='Delete' ></i>";
