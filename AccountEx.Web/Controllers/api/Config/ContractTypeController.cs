...
{
    public class ContractTypeController : GenericApiController<ContractType>
    {

        public override ApiResponse Post([FromBody]ContractType input)
        {
        ...
        private string ServerValidateSave(ContractType input)
        {
            var err = ",";
            try
            {
