...
{
    public class DestinationController : GenericApiController<Destination>
    {

        public override ApiResponse Post([FromBody]Destination input)
        {
        ...
        private string ServerValidateSave(Destination input)
        {
            var err = ",";
            try
            {
