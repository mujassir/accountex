...
{
    public class POLController : GenericApiController<PortofLoading>
    {

        public override ApiResponse Post([FromBody]PortofLoading input)
        {
        ...
        private string ServerValidateSave(PortofLoading input)
        {
            var err = ",";
            try
            {
