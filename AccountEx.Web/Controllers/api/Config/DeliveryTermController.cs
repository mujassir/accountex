...
{
    public class DeliveryTermController : GenericApiController<DeliveryTerm>
    {

        public override ApiResponse Post([FromBody]DeliveryTerm input)
        {
        ...
        private string ServerValidateSave(DeliveryTerm input)
        {
            var err = ",";
            try
            {
