...
{
    public class VesselController : GenericApiController<Vessel>
    {

        public override ApiResponse Post([FromBody]Vessel input)
        {
        ...
        private string ServerValidateSave(Vessel input)
        {
            var err = ",";
            try
            {
