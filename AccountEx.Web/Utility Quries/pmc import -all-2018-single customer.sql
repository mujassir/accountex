...
DECLARE @FiscalId INT = 169;
DECLARE @VoucherNo INT = 1;
DECLARE db_cursor CURSOR FOR
SELECT [Organization Name]
FROM dbo.PMCTempDataExport
WHERE [Organization Name] IS NOT NULL
AND year([pmc close date])=2018
--AND  [Organization Name]='NISHAT MILLS LIMITED (NDF UNIT- 35)'
...
--SET @VoucherNo = 313;
 ...
 INSERT INTO dbo.PMCs
    ...
    FROM dbo.PMCTempDataExport
    WHERE [Organization Name] = @Customer AND year([pmc close date])=2018
