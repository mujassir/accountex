...
var CustomerBalances = function () {
    var API_CONTROLLER = "CustomerBalances";
    var REPORT_HTML = "";
    return {
        init: function () {
            var $this = this;
                 ...
                 return result;
                            ...
                            for (var i in records) {
                                ...
                                for (var j in balances) {
                                    ...
                                    html += `<td${maxAmountThreshold < debitAmount ? " class='red-flag'" : ""}>${data.Code}</td>`;
        ...
        FilterReport: function () {
            ...
            if (city == "0") {
                ...
                $("[data-city]").addClass("hide");
                $("[data-city='" + city + "']").removeClass("hide");
            }
            if (group == "0") {
