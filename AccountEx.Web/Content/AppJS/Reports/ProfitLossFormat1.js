var ProfitLossFormat1 = function () {
                ...
                Common.WrapAjax({
                    ...
                    success: function (res) {
                        if (res.Success) {
                            ...
                            var cgsTotal = Enumerable.From(data).Where("$.SubType=='CGS'").Sum("$.Amount");
                            ...
                            var goodsSoldsTotal = cgsTotal + directExpTotal;

                            html += "<tr data-row='detail'><td>(-) Cost of Goods Sold</td><td>" + Common.GetInt(cgsTotal).format(); + "</td></tr>";
