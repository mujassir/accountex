                ...
                Common.WrapAjax({
                    ...
                    success: function (res) {
                        if (res.Success) {
                            ...
                            //var RevenueFromLots = Enumerable.From(data).Where("$.SubType=='RevenueFromLots'").ToArray();

                           

                            var salesTotal = Enumerable.From(data).Where("$.SubType=='Sales'").Sum("$.Amount");
                            var RevenueFromLots = Enumerable.From(data).Where("$.SubType=='RevenueFromLots'").Sum("$.Amount");
                            var netPLS = RevenueFromLots - res.Data.TotalExpense;

                            var otherIncomeTotal = Enumerable.From(data).Where("$.SubType=='OtherIncome'").Sum("$.Amount");
                         
                            html += "<tr><td>Revenue from Lots</td><td>" + Common.GetInt(RevenueFromLots).format() + "</td></tr>";
                            html += "<tr><td>Less Overheads</td><td>" + Common.GetInt(res.Data.TotalExpense).format() + "</td></tr>";
                            ...
                            var currentStockTotal = Enumerable.From(data).Where("$.SubType=='CurrentStock'").Sum("$.Amount") ;
                            ...
                            html += "<tr class='grand-total'><td><strong>Net PLS</strong></td><td><strong>" + Common.GetInt(netPLS).format(); + "</strong></td></tr>";
                            
                            html += "<tr><td> &nbsp;</td><td></td></tr>";
                            html += "<tr><td>Previous Stock</td><td>" + Common.GetInt(openingStockTotal).format() + "</td></tr>";
                            html += "<tr><td>Current Stock</td><td>" + Common.GetInt(currentStockTotal).format() + "</td></tr>";
