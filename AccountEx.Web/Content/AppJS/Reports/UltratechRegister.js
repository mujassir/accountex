...
var UltratechRegister = function () {
    ...
    return {
        ...
        LoadData: function () {
            ...
            Common.WrapAjax({
                ...
                blockMessage: "Loading" + " " + Common.GetQueryStringValue("type").toLowerCase() + " ...please wait",
                        ...
                        for (var j in sales) {
                            ...
                            for (var k in saleItems) {
                                ...
                                if (type.indexOf("gst") == -1 && type.indexOf("services") == -1) {
                                    html += "<td style='text-align:left'>" + item.UnitCost + "</td>";
                                    html += "<td colspan='2' style='text-align:left'>" + Common.GetInt(item.Amount).format() + "</td>";
                                    //html += "<td>" + Common.GetInt(item.DiscountAmount).format() + "</td>";
                                }
                                else {
                                    html += "<td>" + item.UnitCost + "</td>";
                                    html += "<td>" + Common.GetInt(item.Amount).format() + "</td>";
                                    html += "<td>" + Common.GetInt(item.GSTAmount).format() + "</td>";
                                }
                                html += "<td>" + Common.GetInt(item.NetAmount).format() + "</td></tr>";
                            }
