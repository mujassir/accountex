             ...
             function (key, g) {
                 ...
                 return result;
                        ...
                        for (var i in stockbyGroups) {
                            ...
                            for (var i in stocks) {
                                ...
                                if (typeof Url.type == 'undefined' && Url.type == null) {
                                    html += "<td class='align-right'>" + product.AvgRate.toFixed(2).format() + "</td>";
                                    html += "<td class='stock-value '>" + Common.GetInt(product.StockValue).format() + "</td>";
                                    html += "<td class='book-value hide '>" + product.BookValue.format() + "</td>";
                                }
                                html += "</tr>";
                            }
                            ...
                            if (typeof Url.type == 'undefined' && Url.type == null) {
                                ...
                                html += "<td class='book-value hide'>" + stockbyGroup.TotalBookValue.format(DECIMAL_POINTS_FOR_TOTALS) + "</td>";
                            }
                            html += "</tr>";
                        ...
                        if (typeof Url.type == 'undefined' && Url.type == null) {
                            ...
                            html += "<td class='book-value hide'>" + bookvalueTotal + "</td>";
                        }
                        html += "</tr>";

                        $("#tbldetail tbody").html(html);
                        PharmacyStock.FilterByGroup();
