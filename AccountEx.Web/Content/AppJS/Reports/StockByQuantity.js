            ...
            Common.WrapAjax({
             ...
             function (key, g) {
                 ...
                 return result;
                        ...
                        for (var i in stockbyGroups) {
                            ...
                            if (stockbyGroup.GroupName != undefined && stockbyGroup.GroupName != null && stockbyGroup.GroupName != "null") {
                                ...
                                for (var i in stocks) {
                                    ...
                                    html += "<td class='align-right'>" + Common.GetInt(product.Size) + "</td>";
                                ...
                                html += "<td class='align-right'>" + stockbyGroup.TotalStockOut.format() + "</td><td></td>";
                                html += "<td class='align-right'>" + stockbyGroup.TotalBalance.format() + "</td>";
                                if (typeof Url.type == 'undefined' && Url.type == null) {
                                    html += "<td></td>";
                                    html += "<td class='stock-value align-right num3'>" + Common.GetInt(stockbyGroup.TotalStockValue).format() + "</td>";
                        ...
                        html += "<td class='align-right'>" + stockoutTotal + "</td><td></td>";
