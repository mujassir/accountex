...
var MonthlyCredits = function () {
    ...
    return {
        ...
        LoadData: function () {
            ...
            var qs = "?key=GetVehicleMonthlyCredits";
            qs += "&month=" + month;
            qs += "&year=" + year;
            ...
            Common.WrapAjax({
                ...
                blockMessage: "Loading monthly credit report...please wait",
                success: function (res) {
                    if (res.Success) {
                        ...
                        for (var i in records) {
                            ...
                            html += "<td class='align-right'>" + record.MonthlyDue.format() + "</td>";
                            html += "<td class='align-right'>" + record.MonthlyReceiving.format() + "</td>";
                            html += "<td class='align-right'>" + record.MonthlyOverdue.format() + "</td>";
                        ...
                        if (records.length == 0)
                            html += "  <tr><td colspan='22' style='text-align: center'>No record(s) found</td></tr>";
                        ...
                        html += " <td class='align-right'>" + totalMonthlyDue.format() + "</td>";
                        html += " <td class='align-right'>" + totalMonthlyReceiving.format() + "</td>";
                        html += " <td class='align-right'>" + totalMonthlyOverdue.format() + "</td>";
                        html += "<td class='align-right'></td>";
                        html += "<td class='align-right'></td>";
                        html += "<td class='align-right'></td>";
                        html += "<td class='align-right'></td>";
