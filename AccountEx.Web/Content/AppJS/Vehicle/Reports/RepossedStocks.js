...
var RepossedStocks = function () {
    ...
    return {
        ...
        LoadData: function () {         
            ...
            var qs = "?key=GetRepossessedStocks";
            ...
            Common.WrapAjax({
                ...
                blockMessage: "Loading  Repossed Stocks...please wait",
                success: function (res) {
                    if (res.Success) {
                        ...
                        if (records.length == 0)
                            html += "  <tr><td colspan='17' style='text-align: center'>No record(s) found</td></tr>";
