                    ...
                    success: function (res) {
                        if (res.Success) {
                            ...
                            for (var i = 0; i < saleDetails.length; i++) {
                                var sale = saleDetails[i];
                                html += "<tr data-row='detail'><td>(+) <a href='../reports/GeneralLedger?fromDate=" + date1 + "&toDate=" + date2 + "&accountId=" + sale.AccountId + "' target='_blank'>" + sale.AccountName + "</a></td><td>" + Common.GetInt(saleDetails[i].Amount).format(); + "</td></tr>";
                            }
                        ...
                        return result;
                            ...
                            for (var i in data) {
                                ...
                                for (var j in expenses) {
                                    ...
                                    html += "<tr data-row='detail'><td><a href='../reports/GeneralLedger?fromDate=" + date1 + "&toDate=" + date2 + "&accountId=" + expense.AccountId + "' target='_blank'>" + expense.AccountName + "</a></td><td>" + Common.GetInt(expense.Amount).format(); + "</td></tr>";
                                }
