                    ...
                    if ($(this).val() == "") {
                        ...
                        if (PageSetting.BarCodeEnabled) {
                            ...
                            if (typeof product != "undefined" && product != null) {
                                ...
                                {
                                    $("#item-container tbody tr:nth-last-child(1) td:nth-child(3) input.SaleLessRate").focus().select();
                                }
...
ListView: function () {
    ...
    var $this = this;
    if (!LIST_LOADED) {
        var url = Setting.APIBaseUrl + API_CONTROLLER + "?type=" + GroupSubType[$this.GetType()] + "&grouptype="+GroupType["itemgroup"];
        LIST_LOADED = true;
...
Save: function () {
    ...
    if (Common.Validate($("#form-info"))) {
        ...
        if (Common.Validate($("#mainform"))) {
            ...
            record["GroupType"] = GroupType["itemgroup"];
            ...
            Common.WrapAjax({
                ...
                blockMessage: "Saving ItemGroup...please wait",
                success: function (res) {
                    if (res.Success) {
                        $this.ListView();
        ...
        success: function (res) {
            if (res.Success) {
                ...
                for (var i in items)
                {
                    ...
                    items[i].ItemCode = item.AccountCode;
...
Delete: function (id) {
    ...
    Common.ConfirmDelete(function () {
        Common.WrapAjax({
            ...
            blockUI: true,
            blockElement: "#div-table",
            blockMessage: "Deleting ItemGroup...please wait",
            success: function (res) {
                if (res.Success) {
                    DataTable.RefreshDatatable(DATATABLE_ID);
                }
