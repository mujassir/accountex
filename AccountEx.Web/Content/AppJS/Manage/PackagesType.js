...
var PackagesType = function () {
    ...
    var API_CONTROLLER = "PackagesType";
        ...
        Save: function () {
            ...
            if (Common.Validate($("#form-info"))) {
                ...
                Common.WrapAjax({
                    ...
                    blockMessage: "Saving packages type...please wait",
                    success: function (res) {
                        if (res.Success) {
                            $this.ListView();
        ...
        Edit: function (id) {
           var $this = this;
            Common.WrapAjax({
                ...
                blockMessage: "Loading packages type...please wait",
                success: function (res) {
                    if (res.Success) {
                        var j = res.Data;
           ...
           var $this = this;
            Common.ConfirmDelete(function () {
                Common.WrapAjax({
                    ...
                    blockUI: true,
                    blockElement: "#div-table",
                    blockMessage: "Deleting packages type...please wait",
                    success: function (res) {
                        if (res.Success) {
                            DataTable.RefreshDatatable(DATATABLE_ID);
                        }
