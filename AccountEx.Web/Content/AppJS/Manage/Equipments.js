    ...
    return {
        ...
        Save: function () {
            ...
            if (Common.Validate($("#form-info"))) {
                ...
                Common.WrapAjax({
                    ...
                    blockMessage: "Saving Equipment ...please wait",
                    success: function (res) {
                        if (res.Success) {
                            $this.CustomClear();
                            //$this.ListView();
        ...
        Edit: function (id) {
            ...
            Common.WrapAjax({
                ...
                blockMessage: "Loading Equipment ...please wait",
                success: function (res) {
                    if (res.Success) {
                        var j = res.Data;
        ...
        Delete: function (id) {
            ...
            Common.ConfirmDelete(function () {
                Common.WrapAjax({
                    ...
                    blockUI: true,
                    blockElement: "#div-table",
                    blockMessage: "Deleting Equipment ...please wait",
                    success: function (res) {
                        if (res.Success) {
                            DataTable.RefreshDatatable(DATATABLE_ID);
                            Common.GetNextAccountCode(API_CONTROLLER);
