...
var Designations = function () {
    ...
    var API_CONTROLLER = "Designation";
        ...
        Save: function () {
            ...
            if (Common.Validate($("#form-info"))) {
                ...
                Common.WrapAjax({
                    ...
                    blockMessage: "Saving Designation...please wait",
                    success: function (res) {
                        if (res.Success) {
                            $this.ListView();
        ...
        Edit: function (id) {
           var $this = this;
            Common.WrapAjax({
                ...
                blockMessage: "Loading Designation...please wait",
                success: function (res) {
                    if (res.Success) {
                        var j = res.Data;
           ...
           var $this = this;
            Common.ConfirmDelete(function () {
                Common.WrapAjax({
                    ...
                    blockUI: true,
                    blockElement: "#div-table",
                    blockMessage: "Deleting Designations...please wait",
                    success: function (res) {
                        if (res.Success) {
                            DataTable.RefreshDatatable(DATATABLE_ID);
                        }
