...
var CustomerGroups = function () {
    ...
    var API_CONTROLLER = "CustomerGroup";
        ...
        Save: function () {
            ...
            if (Common.Validate($("#form-info"))) {
                ...
                Common.WrapAjax({
                    ...
                    blockMessage: "Saving customer groups...please wait",
                    success: function (res) {
                        if (res.Success) {
                            $this.ListView();
        ...
        Edit: function (id) {
           var $this = this;
            Common.WrapAjax({
                ...
                blockMessage: "Loading customer group...please wait",
                success: function (res) {
                    if (res.Success) {
                        var j = res.Data;
           ...
           var $this = this;
            Common.ConfirmDelete(function () {
                Common.WrapAjax({
                    ...
                    blockUI: true,
                    blockElement: "#div-table",
                    blockMessage: "Deleting customer group...please wait",
                    success: function (res) {
                        if (res.Success) {
                            DataTable.RefreshDatatable(DATATABLE_ID);
                        }
