    ...
    return {
        ...
        Save: function () {
            ...
            if (Common.Validate($("#form-info"))) {
                ...
                Common.WrapAjax({
                    ...
                    blockMessage: "Saving Warehouse... please wait",
        ...
        Edit: function (id) {
            ...
            Common.WrapAjax({
                ...
                blockMessage: "Loading Warehouse... please wait",
                success: function (res) {
                    if (res.Success) {
                        var j = res.Data;
        ...
        Delete: function (id) {
            ...
            Common.ConfirmDelete(function () {
                Common.WrapAjax({
                    ...
                    blockUI: true,
                    blockElement: "#div-table",
                    blockMessage: "Deleting Warehouse... please wait",
                    success: function (res) {
                        if (res.Success) {
                            DataTable.RefreshDatatable(DATATABLE_ID);
                        }
