...
var PharmacyPurchase = function () {
    ...
    return {
        ...
        GetQuantityPriceTotal: function (tr) {
            ...
            Rate = Common.GetFloat($(tr).find(":nth-child(6) input.Rate").val());
            ...
            $(tr).find(":nth-child(9) input.DiscountAmount ").val(discountAmount.toFixed(2));
            $(tr).find(":nth-child(10) input.NetAmount").val(Common.GetFloat(netAmount.toFixed(3)));
        ...
        CalculateUnitQuantity: function (tr) {
            ...
            var qty = Common.GetInt($(tr).find(":nth-child(3) input.MainUnitQuantity").val());
