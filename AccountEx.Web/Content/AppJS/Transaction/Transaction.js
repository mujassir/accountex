...
var Transaction = function () {
    ...
    var API_CONTROLLER = "Transaction";
    ...
    return {
            ...
            $("#AccountId").change(function () {
                ...
                switch (type) {
                    case "sale":
                        ...
                        break;
                    case "salereturn":
                        $("#Comments").val("Sale Return To: " + $("#AccountId option:selected").text());
                        break;
                    case "purchase":
                        $("#Comments").val("Purchase From: " + $("#AccountId option:selected").text());
                        break;
                    case "purchasereturn":
                        $("#Comments").val("Purchase Return To: " + $("#AccountId option:selected").text());
                        break;
        ...
        AddItem: function () {
            if (Common.Validate($("#addrow"))) {
                ...
                html += "<td>" + rate + "</td>";
                html += "<td>" + amount + "</td>";
                html += "<td style=\"width: 8px;\"><span class=\"action\"><i class=\"fa fa-trash-o\" onclick=\"Transaction.DeleteRow(this)\" data-original-title=\"Delete Item\"></i></span></td>";
                html += "</tr>";
           ...
           var $this = this;
            ...
            if (Common.Validate($("#mainform"))) {
                ...
                if (disocunt > 0) {
                    ...
                    disuocuntentery["AccountTitle"] = "Discount";
                ...
                Common.WrapAjax({
                    ...
                    blockMessage: "Loading  " + $this.GetType() + "  Transaction ...please wait",
                ...
                success: function (res) {
                    if (res.Success) {
                        ...
                        for (var i in items) {
                            ...
                            html += "<tr>";
                            html += "<td><input type='hidden' id='ItemId' value='" + account.Id + "'>";
                            html += "<input type='hidden' id='Id' value='" + item.Id + "'>";
                            html += "" + account.Name + "</td>";
                            html += "<td>" + item.Quantity + "</td>";
                            html += "<td>" + item.Price + "</td>";
                            html += "<td>" + amount + "</td>";
                            //html += "<td>" + gstAmount + "</td>";
           ...
           var $this = this;
            Common.ConfirmDelete(function () {
                Common.WrapAjax({
                    ...
                    blockUI: true,
                    blockElement: "#form-info",
                    blockMessage: "Deleting  " + $this.GetType() + "  Transaction ...please wait",
                    success: function (res) {
                        if (res.Success) {
                            $this.RebindData();
                        }
            ...
            Common.WrapAjax({
                ...
                success: function (res) {
                    if (res.Success) {
                        ...
                        Common.BindSelect(res.Data.MasterAccounts, "#AccountId", true);
