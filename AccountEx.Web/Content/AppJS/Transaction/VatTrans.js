...
var VatTrans = function () {
    var max = 0;
    var LIST_LOADED = false;
    var LIST_CHANGED = false;
    var API_CONTROLLER = "VatTrans";
    ...
    return {
        init: function () {
            ...
            $(document).on("keyup",".GSTAmount", function (event) {
                ...
                var tr = $(this).parent().parent();
                var gstAmount = Common.GetFloat($(this).val());
                var amount = Common.GetFloat($(tr).find("input.Amount").val());
        ...
        GetQuantityPriceTotal: function (tr, gstAmountProvided) {
            $this = this;
            var Quantity = 0.0;
            var Rate = 0.0;
            ...
            if (gstAmountProvided != undefined && gstAmountProvided > 0)
                gstAmount = gstAmountProvided;
            var netAmount = Common.GetFloat(amount + gstamount);
