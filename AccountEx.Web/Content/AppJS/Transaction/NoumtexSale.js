...
var NoumtexSale = function () {
    var max = 0;
    var LIST_LOADED = false;
    var LIST_CHANGED = false;
    var API_CONTROLLER = "Noumtexsale";
    ...
    return {
        ...
        GetWholeTotal: function () {
            ...
            $("#item-container tbody tr").each(function () {
                ...
                TotalAmount += Common.GetInt($(this).find("input.NetAmount").val());
            });
            ...
            $("#item-container tfoot tr").find("input.NetAmount").val(TotalAmount);


            $("#QuantityTotal").val(TotalActWeight.toFixed(2));
            $("#NTQtyTotal").val(TotalQuantity.toFixed(2));
            $("#NetTotal,#GrossTotal").val(TotalAmount);
        ...
        LoadReportData: function (res) {
            ...
            if (res.Data.DeliveryChallans != null) {
                var dcnumbers = Enumerable.From(res.Data.DeliveryChallans).Select(function (x) { return x.InvoiceNumber }).ToArray();
            ...
            html += "<tr>";
            html += "<td colspan='3' class='bold align-right'>Total &nbsp;";
            html += "<td>" + $("#item-container tfoot tr").find("input.TotalMeters").val() + "</td>";
            html += "<td colspan='1'>" + d.QuantityTotal + "</td>";
            html += "<td colspan='1'></td>";
            html += "<td colspan='1'>" + d.NetTotal + "</td>";
            html += "</tr>";
            $("#report-saleitem tbody").append(html);
