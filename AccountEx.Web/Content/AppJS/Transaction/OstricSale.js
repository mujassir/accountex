...
var OstricSale = function () {
    var max = 0;
    var LIST_LOADED = false;
    var LIST_CHANGED = false;
    var API_CONTROLLER = "OstricSale";
    ...
    return {
        ...
        Print: function (isSimple) {
            ...
            $(".div-without-letterheader,.div-with-letterheader").addClass("hide");
            if (isSimple) {
                $("#tblAgingItems").removeClass("hide");
                $(".div-without-letterheader").removeClass("hide");
            }
            else {
                $("#tblAgingItems").addClass("hide");
                $(".div-with-letterheader").removeClass("hide");
            }
            window.print();
        },
