...
var Production = function () {
    ...
    var API_CONTROLLER = "ProductionWithReceipe";
    ...
    return {
        ...
        LoadVoucher: function (key) {
            ...
            Common.WrapAjax({
                url: Setting.APIBaseUrl + API_CONTROLLER + "/" + voucherno + "?type=" + VOUCHER_TYPE + "&key=" + key + "&voucher=" + voucherno,
                type: "GET",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                blockUI: true,
            ...
            Common.WrapAjax({
                ...
                success: function (res) {
                    if (res.Success) {
                        ...
                        var items = d.ProductReceipeitems;
                        ...
                        if (VOUCHER_TYPE == VoucherType.production) {
                            Common.MapItemData(items, null, null, true);
                            Common.MapItemData(masterItems, "#finishedgoods-item-container", "#template-item-finishedgoods", true);
                            $this.AddItem($("#finisheditem-container"));
                        }
                        else {
                            Common.MapItemData(items, "#finishedgoods-item-container", "#template-item-finishedgoods", true);
                            Common.MapItemData(masterItems, null, null, true);
                            $this.AddItem($("#rawitem-container"));
                        }
                        setTimeout(function () {
