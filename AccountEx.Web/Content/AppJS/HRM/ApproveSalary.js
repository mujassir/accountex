var ApproveSalary = function () {
    var max = 0;
    var LIST_LOADED = false;
    var LIST_CHANGED = false;
    var API_CONTROLLER = "ApproveSalary";
    ...
    return {
        init: function () {
            ...
            $("#chkAll").change(function () {
                ...
                $("#unapprovesalary-container tbody input[type='checkbox']").each(function () {
            ...
            $(document).on("change", "#unapprovesalary-container tbody input[type='checkbox']", function () {
                $this.UpdateCheckbox();
            });
        ...
        UpdateCheckbox: function () {
            if ($('#unapprovesalary-container tbody').children().length <= 0 || $('#unapprovesalary-container tbody :checkbox:not(:checked)').length > 0) {
        ...
        Post: function () {
            var $this = this;
            App.blockUI({
                target: $("#approvesalary-container"),
            ...
            setTimeout(function () {
                ...
                App.unblockUI($("#approvesalary-container"));
        ...
        SaveRecord: function (callback) {
            ...
            if (Common.Validate($("#mainform"))) {
                ...
                $("#unapprovesalary-container tbody tr").each(function () {
            ...
            Common.WrapAjax({
                ...
                success: function (res) {
                    if (res.Success) {
                        ...
                        $("#unapprovesalary-container tbody").html("");
                        ...
                        for (var i = 0; i < res.Data.Salaries.length; i++) {
                            ...
                            //}
                            Common.MapItemData(unApproveditems, "#unapprovesalary-container", "#template-unapprovesalary", true);
                            ...
                            if (approvedItems.length > 0) {
                                ...
                                Common.MapItemData(approvedItems, "#approvesalary-container", "#template-approvesalary", true);
        ...
        SendEmail: function (callback) {
            ...
            Common.WrapAjax({
                ...
                blockUI: true,
                blockElement: "#form-info",
                blockMessage: "Posting and Sending Email...please wait",
                success: function (res) {
                    if (res.Success) {
                        $this.GetNextVoucherNumber();
                        $this.CustomClear();
        ...
        Delete: function (el) {
            ...
            var voucher = $(tr).find("input.VoucherNumber").val();
            var id = $(tr).find("input.Id").val();
            var message = "You are trying to delete salary voucher # " + voucher + ", are you sure you want to delete?";
            if (confirm(message)) {
        ...
        Print: function (el) {
            ...
            var basicsalary = $(tr).find("input#BasicSalary").val();
            ...
            var fbasicsalary = Common.GetFloat(basicsalary);
            ...
            if (houseallowance < 1) houseallowance = houseallowance * fbasicsalary;
            if (conveyanceallowance < 1) conveyanceallowance = conveyanceallowance * fbasicsalary;
            if (medicalallowance < 1) medicalallowance = medicalallowance * fbasicsalary;
            ...
            if (providentfund < 1) providentfund = providentfund * fbasicsalary;
            if (socialsecurity < 1) socialsecurity = socialsecurity * fbasicsalary;
            if (eobi < 1) eobi = eobi * fbasicsalary;
            ...
            var tCredit = fbasicsalary + otamount + tallow + bonus;
            var tDebit = absentdeduction + tDeduction + incometax + instal;

            $("#lblCode").text(code);
            $("#lblName").text(name);
            $("#lblVoucherNumber").text(voucher);
            ...
            $("#lblPaymentDate").text($("#PaymentDate").val());
