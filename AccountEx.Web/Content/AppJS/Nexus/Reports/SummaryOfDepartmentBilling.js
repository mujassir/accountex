var SummaryOfDepartmentBilling = function () {
    ...
    return {
        ...
        LoadData: function () {
            ...
            if (Common.Validate($("#form-info"))) {
                ...
                var qs = "?key=SummaryOfDepartmentBilling";
                    ...
                    success: function (res) {
                        if (res.Success) {
                            ...
                            for (var i in monthYears) {
                                ...
                                headerHtml += '<th class="align-right">' + monthYear.Name + '</th>';
                            }
                            headerHtml += "<th class='align-right'>Amount Total</th>";
                            headerHtml += "<th class='align-right'>Avergae Amount</th>";
                            headerHtml += '</tr>';
                           ...
                           function (key, g) {
                            ...
                            for (var i in groupRecord) {
                                ...
                                var totalMonths = monthYears.length <= 0 ? 1 : monthYears.length;
                                var avg = Common.GetInt(totalAmount / totalMonths);
                                html += "<td class='align-right'>" + totalAmount.format() + "</td>";
                                html += "<td class='align-right'>" + avg.format() + "</td>";
                                html += "</tr>";
                                sn++;
